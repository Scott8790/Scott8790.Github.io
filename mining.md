...
<img src="mining_visuals/install_libraries.png?raw=true"/>
...
<img src="mining_visuals/import_libraries.png?raw=true"/>
...
<img src="mining_visuals/upload_data.png?raw=true"/>

Now we are ready to begin the analysis! One of the first codes I wrote was one to see how much data I was dealing with.

<img src="mining_visuals/dataset_size.png?raw=true"/>

the first number is the number of rows and the second is the amount of columns


My boss wanted to see some summary stats for the data. he wanted to see the average, median, min, and max for every column. This can be quickly done in python with the following code: df.describe()

<img src="mining_visuals/data_stats.png?raw=true"/>


Then came the fun part: visualizations. I needed to isolate the important rows and columns the boss wanted to see for this project. I created a variable for defined important columns. And for the rows, i filtered them with a boolean mask and created a new data frame df_june:

<img src="mining_visuals/df_june1st.png?raw=true"/>

this filters the rows to only show June 1st since that is what our boss wanted info on

<img src="mining_visuals/important_cols.png?raw=true"/>
...
<img src="mining_visuals/scatterplots_seaborn.png?raw=true"/>
...
<img src="mining_visuals/June_important_corr.png?raw=true"/>
...
<img src="mining_visuals/lineplot_june1.png?raw=true"/>
...
<img src="mining_visuals/for_loop_code.png?raw=true"/>

for loop code

<img src="mining_visuals/loop_result_1of2.png?raw=true"/>

<img src="mining_visuals/loop_result_2of2.png?raw=true"/>
...
### Let’s Connect!
If this story resonated with you or sparked your curiosity, let’s keep the conversation going! Whether you’re interested in mining, data analysis, or are looking for someone to join your team, I’d love to connect on [LinkedIn](https://www.linkedin.com/in/smsilvey/). Don’t hesitate to share your thoughts or ask questions—I’m all ears!
